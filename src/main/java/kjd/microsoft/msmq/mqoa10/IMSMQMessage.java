...
public interface IMSMQMessage extends Com4jObject {
  ...
  @VTID(21)
  kjd.microsoft.msmq.mqoa10.IMSMQQueueInfo responseQueueInfo();
   ...
   * </p>
   * @param ppqinfoResponse Mandatory kjd.microsoft.msmq.mqoa10.IMSMQQueueInfo parameter.
   */

  @DISPID(4) //= 0x4. The runtime will prefer the VTID if present
  @VTID(22)
  void responseQueueInfo(
    kjd.microsoft.msmq.mqoa10.IMSMQQueueInfo ppqinfoResponse);
  ...
  @VTID(29)
  kjd.microsoft.msmq.mqoa10.IMSMQQueueInfo adminQueueInfo();
   ...
   * </p>
   * @param ppqinfoAdmin Mandatory kjd.microsoft.msmq.mqoa10.IMSMQQueueInfo parameter.
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(30)
  void adminQueueInfo(
    kjd.microsoft.msmq.mqoa10.IMSMQQueueInfo ppqinfoAdmin);
  ...
  @VTID(48)
  kjd.microsoft.msmq.mqoa10.IMSMQQueueInfo destinationQueueInfo();
   ...
   * </p>
   * @param destinationQueue Mandatory kjd.microsoft.msmq.mqoa10.IMSMQQueue parameter.
  ...
  @VTID(54)
  void send(
    kjd.microsoft.msmq.mqoa10.IMSMQQueue destinationQueue,

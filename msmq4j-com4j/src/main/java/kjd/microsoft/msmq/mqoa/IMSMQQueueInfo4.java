...
public interface IMSMQQueueInfo4 extends Com4jObject {
   ...
   * If this queue is already open for receiving it will fail and throw an exception, specifically with HRESULT
   ...
   * @return  Returns a value of type kjd.microsoft.msmq.mqoa.IMSMQQueue4
   */

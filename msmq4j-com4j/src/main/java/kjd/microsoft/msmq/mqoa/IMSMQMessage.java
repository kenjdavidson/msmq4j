...
public interface IMSMQMessage extends Com4jObject {
  ...
  @VTID(21)
  kjd.microsoft.msmq.mqoa.IMSMQQueueInfo responseQueueInfo();
  ...
  @VTID(29)
  kjd.microsoft.msmq.mqoa.IMSMQQueueInfo adminQueueInfo();
  ...
  @VTID(48)
  kjd.microsoft.msmq.mqoa.IMSMQQueueInfo destinationQueueInfo();
   ...
   * </p>
   * @param destinationQueue Mandatory kjd.microsoft.msmq.mqoa.IMSMQQueue parameter.
  ...
  @VTID(54)
  void send(
    kjd.microsoft.msmq.mqoa.IMSMQQueue destinationQueue,

...
public interface IMSMQMessage4 extends Com4jObject {
  ...
  @VTID(48)
  kjd.microsoft.msmq.mqoa.IMSMQQueueInfo4 destinationQueueInfo();
  ...
  @VTID(61)
  kjd.microsoft.msmq.mqoa.IMSMQQueueInfo4 transactionStatusQueueInfo();
  ...
  @VTID(82)
  kjd.microsoft.msmq.mqoa.IMSMQQueueInfo4 responseQueueInfo();
   ...
   * </p>
   * @param ppqinfoResponse Mandatory kjd.microsoft.msmq.mqoa.IMSMQQueueInfo4 parameter.
   */

  @DISPID(44) //= 0x2c. The runtime will prefer the VTID if present
  @VTID(83)
  void responseQueueInfo(
    kjd.microsoft.msmq.mqoa.IMSMQQueueInfo4 ppqinfoResponse);
  ...
  @VTID(84)
  kjd.microsoft.msmq.mqoa.IMSMQQueueInfo4 adminQueueInfo();
   ...
   * </p>
   * @param ppqinfoAdmin Mandatory kjd.microsoft.msmq.mqoa.IMSMQQueueInfo4 parameter.
   */

  @DISPID(45) //= 0x2d. The runtime will prefer the VTID if present
  @VTID(85)
  void adminQueueInfo(
    kjd.microsoft.msmq.mqoa.IMSMQQueueInfo4 ppqinfoAdmin);

...
public interface IMSMQMessage2 extends Com4jObject {
  ...
  @VTID(21)
  kjd.microsoft.msmq.mqoa20.IMSMQQueueInfo responseQueueInfo_v1();
  ...
  @VTID(29)
  kjd.microsoft.msmq.mqoa20.IMSMQQueueInfo adminQueueInfo_v1();
  ...
  @VTID(48)
  kjd.microsoft.msmq.mqoa20.IMSMQQueueInfo2 destinationQueueInfo();
   ...
   * </p>
   * @param destinationQueue Mandatory kjd.microsoft.msmq.mqoa20.IMSMQQueue2 parameter.
  ...
  @VTID(54)
  void send(
    kjd.microsoft.msmq.mqoa20.IMSMQQueue2 destinationQueue,
  ...
  @VTID(61)
  kjd.microsoft.msmq.mqoa20.IMSMQQueueInfo2 transactionStatusQueueInfo();
  ...
  @VTID(77)
  kjd.microsoft.msmq.mqoa20.IMSMQQueueInfo2 responseQueueInfo();
   ...
   * </p>
   * @param ppqinfoResponse Mandatory kjd.microsoft.msmq.mqoa20.IMSMQQueueInfo2 parameter.
   */

  @DISPID(41) //= 0x29. The runtime will prefer the VTID if present
  @VTID(78)
  void responseQueueInfo(
    kjd.microsoft.msmq.mqoa20.IMSMQQueueInfo2 ppqinfoResponse);
  ...
  @VTID(79)
  kjd.microsoft.msmq.mqoa20.IMSMQQueueInfo2 adminQueueInfo();
   ...
   * </p>
   * @param ppqinfoAdmin Mandatory kjd.microsoft.msmq.mqoa20.IMSMQQueueInfo2 parameter.
   */

  @DISPID(42) //= 0x2a. The runtime will prefer the VTID if present
  @VTID(80)
  void adminQueueInfo(
    kjd.microsoft.msmq.mqoa20.IMSMQQueueInfo2 ppqinfoAdmin);

...
public interface IMSMQMessage3 extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo
   */

  @DISPID(4) //= 0x4. The runtime will prefer the VTID if present
  @VTID(21)
  kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo responseQueueInfo_v1();
   ...
   * </p>
   * @param ppqinfoResponse Mandatory kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo parameter.
   */

  @DISPID(4) //= 0x4. The runtime will prefer the VTID if present
  @VTID(22)
  void responseQueueInfo_v1(
    kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo ppqinfoResponse);
  ...
  @VTID(29)
  kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo adminQueueInfo_v1();
   ...
   * </p>
   * @param ppqinfoAdmin Mandatory kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo parameter.
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(30)
  void adminQueueInfo_v1(
    kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo ppqinfoAdmin);
   ...
   * </p>
   * @return  Returns a value of type kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo3
   */

  @DISPID(20) //= 0x14. The runtime will prefer the VTID if present
  @VTID(48)
  kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo3 destinationQueueInfo();
  ...
  @VTID(61)
  kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo3 transactionStatusQueueInfo();
  ...
  @VTID(77)
  kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo2 responseQueueInfo_v2();
   ...
   * </p>
   * @param ppqinfoResponse Mandatory kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo2 parameter.
   */

  @DISPID(41) //= 0x29. The runtime will prefer the VTID if present
  @VTID(78)
  void responseQueueInfo_v2(
    kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo2 ppqinfoResponse);
  ...
  @VTID(79)
  kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo2 adminQueueInfo_v2();
   ...
   * </p>
   * @param ppqinfoAdmin Mandatory kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo2 parameter.
   */

  @DISPID(42) //= 0x2a. The runtime will prefer the VTID if present
  @VTID(80)
  void adminQueueInfo_v2(
    kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo2 ppqinfoAdmin);
  ...
  @VTID(82)
  kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo3 responseQueueInfo();
   ...
   * </p>
   * @param ppqinfoResponse Mandatory kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo3 parameter.
   */

  @DISPID(44) //= 0x2c. The runtime will prefer the VTID if present
  @VTID(83)
  void responseQueueInfo(
    kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo3 ppqinfoResponse);
  ...
  @VTID(84)
  kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo3 adminQueueInfo();
   ...
   * </p>
   * @param ppqinfoAdmin Mandatory kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo3 parameter.
   */

  @DISPID(45) //= 0x2d. The runtime will prefer the VTID if present
  @VTID(85)
  void adminQueueInfo(
    kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo3 ppqinfoAdmin);

...
public interface IMSMQMessage2 extends Com4jObject {
  ...
  @VTID(48)
  kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo2 destinationQueueInfo();
   ...
   * </p>
   * @param destinationQueue Mandatory kjd.microsoft.msmq.mqoa30.IMSMQQueue2 parameter.
  ...
  @VTID(54)
  void send(
    kjd.microsoft.msmq.mqoa30.IMSMQQueue2 destinationQueue,
  ...
  @VTID(61)
  kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo2 transactionStatusQueueInfo();
  ...
  @VTID(77)
  kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo2 responseQueueInfo();
  ...
  @VTID(79)
  kjd.microsoft.msmq.mqoa30.IMSMQQueueInfo2 adminQueueInfo();

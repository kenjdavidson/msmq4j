...
public interface IMSMQQueueInfo extends Com4jObject {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type kjd.microsoft.msmq.mqoa30.IMSMQQueue
   */

  @DISPID(1610743835) //= 0x6002001b. The runtime will prefer the VTID if present
  @VTID(34)
  kjd.microsoft.msmq.mqoa30.IMSMQQueue open(
    int access,
    int shareMode);

...
public interface IMSMQMessage extends Com4jObject {
  ...
  @VTID(21)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo responseQueueInfo();
  ...
  @VTID(29)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo adminQueueInfo();
  ...
  @VTID(48)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo destinationQueueInfo();
   ...
   * </p>
   * @param destinationQueue Mandatory kjd.microsoft.msmq.mqoa40.IMSMQQueue parameter.
  ...
  @VTID(54)
  void send(
    kjd.microsoft.msmq.mqoa40.IMSMQQueue destinationQueue,

...
public interface IMSMQTransactionDispenser2 extends Com4jObject {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type kjd.microsoft.msmq.mqoa40.IMSMQTransaction2
   */

  @DISPID(1610743808) //= 0x60020000. The runtime will prefer the VTID if present
  @VTID(7)
  kjd.microsoft.msmq.mqoa40.IMSMQTransaction2 beginTransaction();

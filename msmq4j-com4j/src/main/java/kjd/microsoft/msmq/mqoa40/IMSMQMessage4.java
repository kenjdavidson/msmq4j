...
public interface IMSMQMessage4 extends Com4jObject {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo4
   */

  @DISPID(20) //= 0x14. The runtime will prefer the VTID if present
  @VTID(48)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo4 destinationQueueInfo();
  ...
  @VTID(61)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo4 transactionStatusQueueInfo();
  ...
  @VTID(82)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo4 responseQueueInfo();
   ...
   * </p>
   * @param ppqinfoResponse Mandatory kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo4 parameter.
   */

  @DISPID(44) //= 0x2c. The runtime will prefer the VTID if present
  @VTID(83)
  void responseQueueInfo(
    kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo4 ppqinfoResponse);
  ...
  @VTID(84)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo4 adminQueueInfo();
   ...
   * </p>
   * @param ppqinfoAdmin Mandatory kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo4 parameter.
   */

  @DISPID(45) //= 0x2d. The runtime will prefer the VTID if present
  @VTID(85)
  void adminQueueInfo(
    kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo4 ppqinfoAdmin);

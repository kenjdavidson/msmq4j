...
public interface IMSMQMessage3 extends Com4jObject {
  // Methods:
  /**
   * <p>
  ...
  @VTID(21)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo responseQueueInfo_v1();
   ...
   * </p>
   * @param ppqinfoResponse Mandatory kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo parameter.
   */

  @DISPID(4) //= 0x4. The runtime will prefer the VTID if present
  @VTID(22)
  void responseQueueInfo_v1(
    kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo ppqinfoResponse);
  ...
  @VTID(29)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo adminQueueInfo_v1();
   ...
   * </p>
   * @param ppqinfoAdmin Mandatory kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo parameter.
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(30)
  void adminQueueInfo_v1(
    kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo ppqinfoAdmin);
   ...
   * </p>
   * @return  Returns a value of type kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo3
   */

  @DISPID(20) //= 0x14. The runtime will prefer the VTID if present
  @VTID(48)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo3 destinationQueueInfo();
  ...
  /**
   * <p>
   * Sends the message to the queue or queues specified by an MSMQDestination object, an MSMQQueue object, or an IADs object that defines an MSMQ destination in Active Directory Domain Services with the optional use of a transaction parameter.
   * </p>
   * @param destinationQueue Mandatory com4j.Com4jObject parameter.
  ...
  @VTID(54)
  void send(
    @MarshalAs(NativeType.Dispatch) com4j.Com4jObject destinationQueue,
  ...
  @VTID(61)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo3 transactionStatusQueueInfo();
   ...
   * </p>
   * <p>
   * Getter method for the COM property "ResponseQueueInfo_v2"
   * </p>
   * @return  Returns a value of type kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo2
   */

  @DISPID(41) //= 0x29. The runtime will prefer the VTID if present
  @VTID(77)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo2 responseQueueInfo_v2();
   ...
   * </p>
   * <p>
   * Setter method for the COM property "ResponseQueueInfo_v2"
   * </p>
   * @param ppqinfoResponse Mandatory kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo2 parameter.
   */

  @DISPID(41) //= 0x29. The runtime will prefer the VTID if present
  @VTID(78)
  void responseQueueInfo_v2(
    kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo2 ppqinfoResponse);
   ...
   * </p>
   * <p>
   * Getter method for the COM property "AdminQueueInfo_v2"
   * </p>
   * @return  Returns a value of type kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo2
   */
  ...
  @VTID(79)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo2 adminQueueInfo_v2();
   ...
   * </p>
   * <p>
   * Setter method for the COM property "AdminQueueInfo_v2"
   * </p>
   * @param ppqinfoAdmin Mandatory kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo2 parameter.
   */

  @DISPID(42) //= 0x2a. The runtime will prefer the VTID if present
  @VTID(80)
  void adminQueueInfo_v2(
    kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo2 ppqinfoAdmin);
  ...
  @VTID(82)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo3 responseQueueInfo();
   ...
   * </p>
   * @param ppqinfoResponse Mandatory kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo3 parameter.
   */

  @DISPID(44) //= 0x2c. The runtime will prefer the VTID if present
  @VTID(83)
  void responseQueueInfo(
    kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo3 ppqinfoResponse);
  ...
  @VTID(84)
  kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo3 adminQueueInfo();
   ...
   * </p>
   * @param ppqinfoAdmin Mandatory kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo3 parameter.
   */

  @DISPID(45) //= 0x2d. The runtime will prefer the VTID if present
  @VTID(85)
  void adminQueueInfo(
    kjd.microsoft.msmq.mqoa40.IMSMQQueueInfo3 ppqinfoAdmin);


  /**
   * <p>
   * Sets/returns an MSMQDestination object specifying one or more queues for returning response messages.
   * </p>
   * <p>
   * Getter method for the COM property "ResponseDestination"
   * </p>
   * @return  Returns a value of type com4j.Com4jObject
   */
  ...
  @VTID(86)
  @ReturnValue(type=NativeType.Dispatch)
  com4j.Com4jObject responseDestination();
   ...
   * </p>
   * <p>
   * Setter method for the COM property "ResponseDestination"
   * </p>
   * @param ppdestResponse Mandatory com4j.Com4jObject parameter.
   */

  @DISPID(46) //= 0x2e. The runtime will prefer the VTID if present
  @VTID(87)
  void responseDestination(
    @MarshalAs(NativeType.Dispatch) com4j.Com4jObject ppdestResponse);


  /**
   * <p>
   * Returns an MSMQDestination object specifying one or more queues to which the message was originally sent.
   * </p>
   * <p>
  ...
  @VTID(88)
  @ReturnValue(type=NativeType.Dispatch)
  com4j.Com4jObject destination();


  /**
   * <p>
   * Returns a Variant containing a string representation of the 64-bit lookup indentifier of the message.
   * </p>
   * <p>
   * Getter method for the COM property "LookupId"
   * </p>
   * @return  Returns a value of type java.lang.Object
   */
  ...
  @VTID(89)
  @ReturnValue(type=NativeType.VARIANT)
  java.lang.Object lookupId();


  /**
   * <p>
   * Returns a Boolean indicating whether the message was authenticated (True) or not (False).
   * </p>
   * <p>
   * Getter method for the COM property "IsAuthenticated2"
   * </p>
  ...
  /**
   * <p>
   * Returns a Boolean indicating whether the message was the first message sent in a transaction (True) or not (False).
   * </p>
   * <p>
   * Getter method for the COM property "IsFirstInTransaction2"
   * </p>
   * @return  Returns a value of type boolean
   */
  ...
  @VTID(91)
  boolean isFirstInTransaction2();


  /**
   * <p>
   * Returns a Boolean indicating whether the message was the last message sent in a transaction (True) or not (False).
   * </p>
   * <p>
   * Getter method for the COM property "IsLastInTransaction2"
   * </p>
   * @return  Returns a value of type boolean
   */
  ...
  @VTID(93)
  void attachCurrentSecurityContext2();


  /**
   * <p>
   * Returns the SOAP envelope of an HTTP message.
   * </p>
   * <p>
   * Getter method for the COM property "SoapEnvelope"
   * </p>
   * @return  Returns a value of type java.lang.String
   */
  ...
  @VTID(94)
  java.lang.String soapEnvelope();


  /**
   * <p>
   * Returns an array of bytes containing the entire contents of an HTTP message, including the SOAP envelope and the SOAP attachments associated with it.
   * </p>
   * <p>
   * Getter method for the COM property "CompoundMessage"
   * </p>
   * @return  Returns a value of type java.lang.Object
   */
  ...
  @VTID(95)
  @ReturnValue(type=NativeType.VARIANT)
  java.lang.Object compoundMessage();
   ...
   * </p>
   * <p>
   * Setter method for the COM property "SoapHeader"
   * </p>
   ...
   * </p>
   * <p>
   * Setter method for the COM property "SoapBody"
   * </p>
   * @param rhs Mandatory java.lang.String parameter.
   */
